...
public class Main {
  public static void main(String[] args) throws Exception {
    //Reading input file "input.txt" for processing
...
//Storing product info in ArrayList "goodies_items"
    ...
    int min_index = 0;
    //Loop to find first index of minimum difference items
    ...
    // writing output file for processing
